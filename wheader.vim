...
"    wheader.vim                                       :+:       :+:           "
"                                                     +:+       +:+            "
"    By: westar <me@westar.tech>                     +#+  +:+  +#+             "
"                                                   +#+ +#+#+ +#+              "
"    Created: 2019/10/15 07:40:42 by westar         #+#+# #+#+#                "
"    Updated: 2019/10/15 07:40:56 by westar         ###   ###   estar.tech     "
"                                                                              "
" **************************************************************************** "
...
function! s:mail()
	let l:mail = $MAIL
	if exists('g:usermail')
		let l:mail = g:usermail
	endif
	if strlen(l:mail) == 0
		let l:mail = "unset@unset.ex"
	endif
	return l:mail
endfunction
